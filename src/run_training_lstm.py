...
from train.train_lstm import train
import reader
...
x_train = x_train.reshape([n_sequences_train, input_seq_len, 1, input_size])
y_train = y_train.reshape([n_sequences_train, input_seq_len, 1, output_size])
...
for epoch in range(n_epochs):
    ...
    print("traing loss is %f" % train_loss)
